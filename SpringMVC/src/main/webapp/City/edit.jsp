...
<form class="layui-form" lay-filter="myform" action="City/insert.do">
</c:if>
<c:if test="${param.id!=null}">
<form class="layui-form" lay-filter="myform" action="City/update.do">
...
function init(){
	$.post("City/edit.do", {id:id}, function(json) {
		render('myform', json);
		getlist("City/getPros.do",{},"[name=father]",json.father);
	},"json");
}
if(id.length>0){
	init();
}else{
	getlist("City/getPros.do",{},"[name=father]",0);
}
</script>
</body>
</html>